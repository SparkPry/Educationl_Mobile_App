          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                onPressed:
                    (_selectedSavedMethod == null && _selectedNewType == null)
                        ? null
                        : () {
                          if (_selectedSavedMethod != null) {
                            String detail =
                                _selectedSavedMethod!.type.name.toUpperCase();
  ...
  Widget _buildSavedMethodItem(PaymentMethod method) {
    ...
    if (method.type == PaymentType.visa ||
      ...
      return GestureDetector(
        ...
        child: SavedPaymentCard(method: method, isSelected: isSelected),
      );
    } else {
