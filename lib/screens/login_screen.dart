  ...
  Future<void> _handleAuthAction() async {
    ...
    try {
      if (isSignIn) {
        ...
        final hasFilledProfile = prefs.getBool('hasFilledProfile') ?? false;
        ...
        // After registration, the API likely returns the same token structure as login
        // If not, we might need to login automatically or handle it based on the response.
        // For this implementation, we'll assume registration succeeded and we want to 
        // capture nickname/email details on the next screen.
        ...
        if (response.data['token'] != null) {
          ...
          // If no token, just switch to sign in mode as before
          setState(() {
            isSignIn = true;
          });
